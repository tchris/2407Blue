...
def store_text():
    ...
    data = {
        ...
        "Shooting Direction": shooting_direction,
        "Humidity": humidity,
    ...
    print("Calling Output Page Function", data)  # Placeholder until the function is created
...
ammunition_dropdown = ttk.Combobox(main_frame, textvariable=ammunition_var, values=["5.56mm", "7.62mm", "9mm", "12 gauge"], state="readonly")
